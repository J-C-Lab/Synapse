...
function installElectronApi(settings: SynapseUserSettings): TestElectronApi {
  const api = {
    ...
    addExecutionWorkspace: vi.fn().mockResolvedValue({ id: "repo", root: "/tmp/repo" }),
    removeExecutionWorkspace: vi.fn().mockResolvedValue(true),
    pickExecutionWorkspaceFolder: vi.fn().mockResolvedValue(null),
