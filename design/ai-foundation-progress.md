...
- `pnpm typecheck` ✅ · `pnpm lint` ✅ · `pnpm test` **392 passed**(P0 +6,P1 +23,P2 +22,P3 +15,P4 +5,P5a +18,P5b +7,增强-Markdown +4,增强-会话侧栏 +3,增强-审批持久化 +5,增强-HTTP MCP +8,增强-记忆 +11)
- 增强项设计交接单见 [ai-enhancements.md](ai-enhancements.md)(Markdown、会话侧栏、审批持久化、HTTP MCP、长期记忆[embeddings] 全部完成)。
...
- **AI 深化**:✅ 代码块语法高亮(`shiki`)、✅ token 预算上限、✅ RAG 文档分块 ingest(P6b)、✅ MCP 密钥加密落盘。
