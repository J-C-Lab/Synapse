...
- `pnpm typecheck` ✅ · `pnpm lint` ✅ · `pnpm test` **365 passed**(P0 +6,P1 +23,P2 +22,P3 +15,P4 +5,P5a +18,P5b +7,增强-Markdown +4)
- 增强项设计交接单见 [ai-enhancements.md](ai-enhancements.md)(Markdown 已完成;会话侧栏/审批持久化/HTTP MCP/记忆 待做)。
