...
- `pnpm typecheck` ✅ · `pnpm lint` ✅ · `pnpm test` **381 passed**(P0 +6,P1 +23,P2 +22,P3 +15,P4 +5,P5a +18,P5b +7,增强-Markdown +4,增强-会话侧栏 +3,增强-审批持久化 +5,增强-HTTP MCP +8)
- 增强项设计交接单见 [ai-enhancements.md](ai-enhancements.md)(Markdown、会话侧栏、审批持久化、HTTP MCP 已完成;记忆/RAG 进行中——用 embeddings)。
